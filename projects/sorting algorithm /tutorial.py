...
import math
pygame.init()
# class to store variables for ease access
class DrawInformation:
    ...
    # color gradients for rectangles
    GRADIENTS = [
        (123, 129, 158),
        (150, 160, 170),
        (198, 190, 194)
    ...
    SIDE_PAD = 100
    TOP_PAD = 150
# function for the initialization of the program
...
# list to be sorted 
    def set_list(self, lst): 
        ...
        # calculating theh width and height of the rectangles
...
def draw(draw_info, algo_name, ascending):
    draw_info.window.fill(draw_info.BACKGROUNG_COLOR)
...
def draw_list(draw_info, color_positions = {}, clear_bg = False ):
   ...
   if clear_bg:
        ...
        pygame.draw.rect(draw_info.window, draw_info.BACKGROUNG_COLOR, clear_rect)
...
def generate_starting_list(n, min_val, max_val):
    lst = []
    # random generation of the values for the rectangle
    for _ in range(n):
